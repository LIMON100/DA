...
def main():
  ...
  GT_PATH = os.path.join(parent_path, 'I:/JumpWatts/Dataset/map/test-helmt/new-mp/new2','ground-truth')
  #print(GT_PATH)
  os.chdir(GT_PATH)
...
def pass_data():
  ...
  src = 'I:/JumpWatts/Dataset/map/test-helmt/new-mp/new2/ground-truth'
  dst = 'I:/JumpWatts/Dataset/map/test-helmt/new-mp/new2/actual'

...
def convert_csv(csv_file_name, output_dir):

    save_root2 = output_dir
    ...
    #with open('files1.csv', 'r', encoding='utf-8') as f_input_csv:
    with open(csv_file_name, 'r', encoding='utf-8') as f_input_csv:
